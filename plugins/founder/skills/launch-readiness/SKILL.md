...
1. Define what "launch" means here and what success looks like for this scope.
2. Check offer, audience, messaging, and the response path after interest or payment appears.
3. Review sequencing, ownership, fulfillment, support, refunds, follow-up, and incident handling.
4. Record evidence and material unknowns. Never treat absence of evidence as approval.
5. Identify legal or compliance escalation triggers. Do not attest legal readiness or draft policies, terms, contracts, or entity advice.
6. Apply the decision gates below and return exactly one verdict: `GO`, `NARROW`, or `DELAY`.
7. State the smallest material fixes that change the verdict.
