...
- Hand off priority and calendar execution to `operating-priorities`, investor-narrative review to `fundraising-ask-review`, pricing and packaging choices to `pricing-strategy`, and focus-metric selection to `north-star-metric`. Own numerical funding gaps, runway, margin, and cash tradeoffs here.
