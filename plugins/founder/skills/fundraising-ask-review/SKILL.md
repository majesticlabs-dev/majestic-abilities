...
1. Restate round context from supplied inputs: amount, instrument-as-fact, use of funds, milestone, timeline, investor targets.
2. Reconcile arithmetic:
...
3. Review narrative clarity on problem, traction, market, team, and why now.
4. Classify each material claim as supported fact, inference, aspiration, or unsupported assertion.
5. Check consistency across deck, memo, email, and meeting narrative when multiple artifacts are provided.
6. Assess investor-fit only against user-supplied or verified current thesis, stage, and check-size information; otherwise label fit unknown.
7. Tighten framing without changing facts. Flag diligence gaps before outreach.
