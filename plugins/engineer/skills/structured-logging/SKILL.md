...
|----------|---------|-------|
| Python | `structlog` or standard-library logging with a JSON formatter | Verify current framework integration |
| Ruby/Rails | `Rails.event` where supported, or a structured logger | Verify the application and Rails versions |
