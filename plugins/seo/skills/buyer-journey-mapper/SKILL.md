...
description: "Create persona x journey grids for AEO content strategy. Use when mapping content to buyer stages, planning question-based content for AI citations, or building a content matrix that covers all personas across awareness, consideration, and decision stages."
---

# Buyer Journey Mapper

**Audience:** Content strategists optimizing for AI citations
**Goal:** Create question-based content grids mapped to buyer personas and journey stages
...
2. **Social Listening** (Reddit, Quora)
   - Community questions
...
| **Decision** | "Can [Product] accomplish [Subtask]?" | Use cases, ROI calculators |

## Output

```markdown
## Buyer Journey Content Grid: [Product/Topic]

### Personas
- Persona A: [specific description]
- Persona B: [specific description]
- Persona C: [specific description]

### Grid
[3×4 table with specific questions]

### Query Sources
- Keyword data: [sources used]
- Social: [communities monitored]
- Internal: [data sources]

### Priority Queue
1. [Highest-opportunity question]
2. [Next priority]
...
```
